<template>
  <div class="w-full mt-6 mx-4 p-12 bg-white rounded-lg overflow-hidden sm:max-w-lg">
    <div class="space-y-4">
      ...
      <div>
        <button type="submit"
          class="border rounded-full shadow-sm font-bold py-2.5 px-4 focus:outline-none focus:ring focus:ring-opacity-50 bg-steelBlue hover:bg-darkAzureBlue text-white border-transparent focus:border-lightAzure focus:ring-lightPastalBlue block w-full transition"
          :disabled="loading">
