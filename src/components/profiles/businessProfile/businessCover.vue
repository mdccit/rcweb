<template>
    <section class="w-full mb-5 p-3">
        <div class="relative">
            ...
            <div @click="toggleModal('cover')" class="absolute top-0 right-0 mt-[8px] mr-[8px] cursor-pointer bg-white p-1 rounded-md">
...
import CoverModal from '~/components/profiles/businessProfile/modals/coverModal.vue';
