            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                                        ...
                                        <div class="">
                                            <div class="">
                                                ...
                                                <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                    <textarea id="user_bio" v-model="bio" autocomplete="user_bio"
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="button" @click="updateBusinessBio"
...
const updateBusinessBio = async () => {
    try {
        const request_body = {
            bio: bio.value,
            business_slug:props.slug
        }; 
        const response = await $publicService.update_business_bio(request_body);  // Pass slug and request body
