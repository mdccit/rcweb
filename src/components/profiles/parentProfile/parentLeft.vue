<template>
    <div class="p-2">
        <div class=" card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white border-opacity-40 p-3 mt-3">
            <div class="flex items-center justify-between w-full">
                <h1 class="text-lg font-semibold text-black">Bio</h1>
                <div class="w-5 h-5 bg-timberwolf rounded-full flex justify-center items-center cursor-pointer text-steelBlue" @click="toggleModal('bio')">
            ...
            <p class="text-xs text-darkSlateBlue leading-relaxed mb-4 text-base break-all">
                {{ bio }}
            </p>
