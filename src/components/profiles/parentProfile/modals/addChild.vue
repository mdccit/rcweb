<template>
    ...
    <div v-if="isVisible" class="relative z-index-220" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                    ...
                                    <div class="mt-2">
                                        <div>
                                            ...
                                            <div class="grid  grid-cols-6 gap-2 mb-2">
                                                ...
                                                <div class="mb-2 col-span-3">
                                                    <label class="block mb-1 text-gray-700 font-sans text-sm">Budget
                                                        <span aria-hidden="true" class="text-red-600"
                                                            title="This field is required">*</span></label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                        <BudgetDropdown :player_budgets="budgets"
                                                            v-model="selectedBudget" id="budgets" label="Budgets *" />
                                                    </div>
                                                </div>
                                                <!-- Graduation month -->
                                                <div class="mb-2 col-span-3">
                                                ...
                                                <!-- Height -->
                                                <div class="mb-2 col-span-6">
                                                    <label class="block mb-2 text-gray-700 font-sans text-sm">Height
                                                        <span aria-hidden="true" class="text-red-600"
                                                            title="This field is required">*</span></label>
                                                    <div class="flex text-last mb-2">
                                            ...
                                            <div class="grid s grid-cols-6 gap-2 mb-2">
                                                <!-- UTR -->
                                                <div class="mb-2 col-span-3 ">
