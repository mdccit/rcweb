                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Player Update Information</h3>
                                <div class="mt-2"><div>
                                    <div class="grid sm:grid-cols-1 grid-cols-1 gap-2 mb-2">
                                        ...
                                        <!--Nationality -->
                                        <div class="mb-2 sm:col-span-2 col-span-1">
                                            <label class="block mb-1 text-gray-700 font-sans text-sm">Country</label>
                                            <div class="flex rounded-lg border border-gray-300 shadow-sm">
