<template>
    ...
    <div v-if="isVisible" class="relative z-320" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="z-index: 201;">
                ...
                <form @submit.prevent="playerAdd">
                    <div
                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Player
                                    ...
                                    <div class="mt-2">
                                        <div>
                                            <div class="grid  grid-cols-6 gap-2 mb-2">
                                                ...
                                                <!--Last Name -->
                                                <div class="mb-2 col-span-3">
                                                    <label class="block mb-1 text-gray-700 font-sans text-sm">Last
                                                        Name</label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                ...
                                                <div class="mb-2 col-span-3">
                                                    <label
                                                        class="block mb-1 text-gray-700 font-sans text-sm">Nationality</label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                        <NationalityDropdown :nationalities="nationalities"
                                                            v-model="nationality" id="nationality"
                                                            label="Nationality" />
                                                    </div>
                                                </div>
                                                <!--Nationality -->
                                                <div class="mb-2 col-span-3">
                                                    <label
                                                        class="block mb-1 text-gray-700 font-sans text-sm">Country</label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                            ...
                                            <div class="grid grid-cols-6  gap-2 mb-2">
                                                ...
                                                <div class="mb-2 col-span-1">
                                                    <label class="block mb-1 text-gray-700 font-sans text-sm">
                                            ...
                                            <div class="grid  grid-cols-6 gap-2 mb-2">
                                                ...
                                                <div class="mb-2 col-span-3">
                                                    <label for="gender"
                                                        class="font-normal block text-sm text-gray-900 dark:text-gray mb-1">Gender
                                                        <span class="text-red-600">*</span> </label>
                                                    <div
                                                        class="flex rounded-lg border border-gray-300 shadow-sm w-full">
                                                ...
                                                <div class="mb-2 sm col-span-3">
                                                    <label for="handedness"
                                                        class="font-normal block mb-2 text-sm text-gray-900 dark:text-gray">Handedness
                                                        <span class="text-red-600">*</span> </label>
                                                    <div
                                                        class="flex rounded-lg border border-gray-300 shadow-sm w-full">
                                                        <HandednessDropdown :handedness="handednesses"
                                                            v-model="handedness" id="handedness" label="Handedness *" />
                                                    </div>
                                                </div>
                                                <!-- Budget Min -->
                                                <div class="mb-2  col-span-3">
                                                    <label class="block mb-1 text-gray-700 font-sans text-sm">Budget min
                                                    </label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                        <input type="text" id="phone_number" v-model="budget_min"
                                                            class="block w-full h-12 border-0 focus:border-lightAzure focus:ring focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed rounded-lg"
                                                            placeholder="Enter Budget Min" />
                                                    </div>
                                                </div>
                                                <!-- Budget Max-->
                                                <div class="mb-2  col-span-3">
                                                    <label class="block mb-1 text-gray-700 font-sans text-sm">Budget Max
                                                    </label>
                                                    <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                                        <input type="text" id="phone_number" v-model="budget_max"
                                                            class="block w-full h-12 border-0 focus:border-lightAzure focus:ring focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed rounded-lg"
                                                            placeholder="Enter Budget Max" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-2 sm:col-span-2 col-span-1">
                                                <label class="block mb-1 text-gray-700 font-sans text-sm">Height
                                                    <span aria-hidden="true" class="text-red-600"
                                                        title="This field is required">*</span></label>
                                                <div class="flex text-last mb-1">
                                                    <div class="flex items-center">
                                                        <input type="radio" id="height_in_cm" v-model="height_in_cm"
                                                            :value="true" />
                                                        <label for="height_in_cm"
                                                            class="ml-2 text-sm text-gray-900">Centimeters</label>
                                                    </div>
                                                    <div class="flex items-center ml-3">
                                                        <input type="radio" id="height_ft_in" v-model="height_in_cm"
                                                            :value="false" />
                                                        <label for="height_ft_in"
                                                            class="ml-2 text-sm text-gray-900">Feet/Inches</label>
                                                    </div>
                                                </div>
                                                <div v-if="height_in_cm"
                                                    class="flex rounded-lg border border-gray-300 shadow-sm">
                                                ...
                                                <div v-else class="flex gap-2 mb-2">
                                                    <div class="flex-1 rounded-lg border border-gray-300 shadow-sm">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button type="submit" @click="playerUpdate"
...
watch(() => props.isVisible, () => {
    first_name.value = props.data.first_name
    last_name.value = props.data.last_name
    email.value = props.data.email
    nationality.value = props.data.nationality_id

    gender.value = props.data.gender

    const fullDate = props.data.graduation_month_year ?? ''
    graduation.value = fullDate.slice(0, 7);
    // height_ft.value= props.data.
    // height_in.value= props.data.
    height_cm.value = props.data.height
    height_in_cm.value = true
    gpa.value = props.data.gpa ?? ''
    if (props.data.other_data) {
        budget_max.value = props.data.other_data.budget_max ?? ''
        budget_min.value = props.data.other_data.budget_min ?? ''
        console.log(budget_max.value)
        utr.value = props.data.other_data.utr ?? ''
        handedness.value = props.data.other_data.handedness

    }

    if (props.data.phone_info) {
        country.value = props.data.phone_info.country_id ?? ''
        phone_number.value = props.data.phone_info.phone_number ?? ''
        phone_code_country.value = props.data.phone_info.phone_code ?? ''
...
const playerUpdate = async () => {
    try {
        ...
        const response = await $publicService.update_parent_child(request_body);
