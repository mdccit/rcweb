<template>
    <div class="card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white w-full p-6 mt-5">
                         ...
                         <div class="flex">
                             <div v-for="member in props.getChild"class="flex-1 p-1">
                                 <!-- member card start-->
                                 <div class="bg-white p-4 border rounded-2xl">
                                     <div class=" grid grid-cols-12 gap-4">
                                         ...
                                         <div class="col-span-3">
                                             <h4 class="text-black">UTR <span class="text-blue-500">{{ member.other_data.utr }}</span></h4>
                                         </div>
                                     </div>
                     ...
                     <AddChildTab :isVisible="showModal" @close="showModal = false"  :parentSlug="route.params.slug" @updatePage="updatePage"/>
                     <UpdateChild :isVisible="showUpdateModal" @close="showUpdateModal = false"  :parentSlug="route.params.slug" :data="updateData" @updatePage="updatePage"/>
