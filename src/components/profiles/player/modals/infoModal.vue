                                ...
                                <div class="mt-2 grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label for="nationality"
                                            class="block mb-1 text-sm font-normal text-gray-900">Nationality</label>
                                    ...
                                    <!-- Date of Birth -->
                                    <div>
                                        <label for="date_of_birth" class="block mb-1 text-sm font-normal text-gray-900">Date of Birth</label>
                                        <input type="date" v-model="date_of_birth" class="w-full border border-gray-300 rounded-lg shadow-sm" />
                                    </div>

                                            <!-- Weight -->
                                            <div class="col-span-2">
                                                <div class="mb-1 flex items-center justify-between">
                                                    <label for="weight" class="block text-sm font-normal text-gray-900">Weight <span class="text-red-600">*</span></label>
                                                    <div class="flex items-center space-x-3">
                                                        <label class="flex items-center">
                                                            <input type="radio" v-model="weight_in_kg" :value="true" class="mr-1" />
                                                            <span class="text-sm text-gray-900">Kilograms</span>
                                                        </label>
                                                        <label class="flex items-center">
                                                            <input type="radio" v-model="weight_in_kg" :value="false" class="mr-1" />
                                                ...
                                                <div v-if="weight_in_kg">
                                                    <input type="number" v-model="weight_kg" class="block w-full rounded-lg border-gray-300 shadow-sm" placeholder="Weight in kg" />
                                                </div>
                                                <!-- Weight in Pounds -->
                                                <div v-else>
                                                    <input type="number" v-model="weight_lb" class="block w-full rounded-lg border-gray-300 shadow-sm" placeholder="Weight in lb" />
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <label for="handedness"
                                            class="block mb-1 text-sm font-normal text-gray-900">Handedness</label>
                                        <HandednessDropdown :handednesses="handednesses" v-model="handedness"
                                            id="handedness" />
                                    </div>
                                    ...
                                    <div>
                                        <label for="gender"
                                            class="block mb-1 text-sm font-normal text-gray-900">Gender</label>
                                    ...
                                    <div class="col-span-2">
                                        <div class="mb-1 flex items-center justify-between">
                                            <label for="height" class="block text-sm font-normal text-gray-900">Height
                                                <span class="text-red-600">*</span></label>

                                            <!-- Toggle between Feet/Inches and Centimeters -->
                                            <div class="flex items-center space-x-3">
                                                <label class="flex items-center">
                                                    <input type="radio" id="player_height_in_cm" v-model="height_in_cm"
                                                        :value="true" class="mr-1" />
                                        ...
                                        <div v-if="height_in_cm">
                                            <div class="relative">
                                                <input type="number" id="player_height_cm" v-model="height_cm"
        ...
        errors.height_in.join(',') }}</span>
                                    ...
                                    <div>
                                        <label for="preferred_surface"
                                            ...
                                            Surface</label>
                                        <select v-model="preferred_surface"
                                    ...
                                    <div>
                                        <label for="graduation_month_year"
                                            ...
                                            Month/Year</label>
                                        <input type="month" v-model="graduation_month_year"
                                            class="w-full border border-gray-300 rounded-lg shadow-sm" />
                                    </div>
                                </div>
                            </div>
