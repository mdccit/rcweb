          ...
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <div
                  ...
                  <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div class="sm:flex sm:items-start">
                          <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                              <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Change your Contact Information</h3>
                              <div class="mt-2">
                                  <p class="text-sm text-gray-500 mb-3">Please update your contact information below:</p>
                                  ...
                                  <div>
                                      <div class="grid sm:grid-cols-1 grid-cols-1 gap-2 mb-2">
                                          ...
                                          <!-- Address Line 2 -->
                                          <div class="mb-2 sm:col-span-2 col-span-1">
                                              <label class="block mb-1 text-gray-700 font-sans text-sm">Address Line 2</label>
                                              <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                      ...
                                      <div class="grid sm:grid-cols-1 grid-cols-1 lg:grid-cols-2 gap-2 mb-2">
                                          ...
                                          <div class="mb-2 sm:col-span-2 col-span-1">
                                              <label class="block mb-1 text-gray-700 font-sans text-sm">Phone Code</label>
                                              <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                          ...
                                          <div class="mb-2 sm:col-span-2 col-span-1">
                                              <label class="block mb-1 text-gray-700 font-sans text-sm">Phone Number</label>
                                              <div class="flex rounded-lg border border-gray-300 shadow-sm">
                  ...
                  <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                      <button type="button"
                          class="inline-flex w-full justify-center rounded-md bg-steelBlue px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Save changes</button>
...
const fetchPlayerContact = async (slug) => {
    try {
        ...
        if (dataSets.user_address_info) {
            ...
            state_province.value = dataSets.user_address_info.state_province ?? 'User has not entered stare provice'
        }

        if (dataSets.user_phone_info) {
            phone_number.value = dataSets.user_phone_info.phone_number ?? 'User has not entered phone number'
            phone_code_country.value = dataSets.user_phone_info.phone_code ?? ''
        }
    } catch (error) {
