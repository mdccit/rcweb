    ...
    <div v-if="visible" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <form @submit.prevent="updateBusinessUserAddress">
                <div
...
onMounted(async () => {
    ...
    if (props.slug) {
        ...
        await fetchBusinessUserContact();
...
const updateBusinessUserAddress = async () => {
    try {
        ...
        const response = await $userService.update_business_user_contact_info(request_body);  // Pass slug and request body
