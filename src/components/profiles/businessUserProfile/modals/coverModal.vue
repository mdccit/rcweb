        ...
        <div
              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                ...
                <div class="mt-2 w-full">
                  ...
                  <!-- <div class="w-full mt-3">
                    ...
                    <div class="flex rounded-lg border border-gray-300 shadow-sm w-full h-12">
                      <label for="profile_picture"
                        class=" img-inputblock w-[120px] pt-2 h-12 px-4 py-2 text-sm font-medium text-black bg-gray-50 border border-gray-300 rounded-lg cursor-pointer focus:outline-none img-input absolute">
                        Choose file
                      </label>
                      <input id="cover_picture" type="file" @change="handleFileChange" accept="image/jpeg, image/png"
                        class="w-full block px-5 py-3 h-12 border-0 focus:border-lightAzure focus:ring focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed rounded-lg">
                    </div>
                  ...
                  <!-- <div class="w-full flex justify-center rounded-lg mt-3" v-if="profile_picture_preview">
                  ...
                  <div class="w-full mt-3">
                    ...
                    <div class="flex rounded-lg border border-gray-300 shadow-sm w-full">
                      ...
                      <label for="profile_picture"
                        class=" absolute img-inputblock w-[110px] pt-[13px] h-12 px-4 py-2 text-sm font-medium text-black bg-gray-50 border border-gray-300 rounded-lg cursor-pointer focus:outline-none img-input">
                        Choose file
                      </label>
                      <input id="cover_picture" type="file" @change="handleFileChange" accept="image/jpeg, image/png"
          ...
          <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button type="button" @click="saveName"
              ...
              changes
              <svg v-if="loading" aria-hidden="true" role="status" class="inline w-4 h-4 mt-[3px] ml-[5px] me-3 text-white animate-spin"
...
const saveProfilePicture = async () => {
  ...
  try {
    ...
    const response = await $userService.upload_business_user_cover_photo(cover_picture.value, user_slug); // Call the upload function
