            ...
            <div class="flex flex-wrap mt-2">
                <div class="flex-1">
                    <input type="text"  v-model="utrMin" @change="utrMinChange"
                        class="w-full  text-black px-3 py-2 border rounded-lg border-timberwolf rounded  focus:border-lightAzure focus:ring focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed"
                        placeholder="Min">
                </div>
                <div class="flex-1">
                    <input type="text"  v-model="utrMax" @change="utrMaxChange"
                        class="w-full  text-black px-3 py-2 border rounded-lg border-timberwolf rounded  focus:border-lightAzure focus:ring focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed ml-2"
                        placeholder="Max">
                </div>
            </div>
        </div>
