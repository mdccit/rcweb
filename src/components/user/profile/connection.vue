<template>
    ...
    <div class="w-[full] grid grid-cols-2">
        <div v-for="connection in connections" class="col-span-1 p-2 w-[450px]">
            <div class="bg-white p-4 border rounded-2xl">
                <div class=" grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <div class="text-sm ml-2 text-black">{{ connection.city }}, {{ connection.country }}</div>
                        </div>
                    </div>
                    <div class="col-span-3">
                ...
                <div class="flex mt-2">
                    ...
                    <div class="flex-1 text-right">
                        ...
                        <button v-if="connection.connection_status == 'connect'"
                ...
                <div class="flex mt-2">
                    <div class="flex-1">
                        <div class="flex items-center space-x-2 mb-2">
                            ...
                            <div class="text-xs ml-2 text-black"><span class="text-blue-700">Ralph,Cameron</span> 3 more
                                mutual connections
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-1 p-2  w-[450px]">
            <div class="bg-white p-4 border rounded-2xl w-[400px]">
                <div class=" grid grid-cols-12 gap-4">
                    <div class="col-span-3">
                        <img class=" rounded-2xl w-[85px] h-[85px]" src="@/assets/user/images/Rectangle 193.png"
                            alt="Neil image">
