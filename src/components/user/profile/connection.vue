                    ...
                    <div class="col-span-6">
                     ...
                     <div class="flex mt-2">
                        ...
                        <div class="flex-1 text-right">
                            ...
                            <button @click="connectRequestSend(connection.id)" v-if="connection.connection_status=='connect'"
                            ...
                            <button v-if="connection.connection_status=='accepted'" class="bg-lighterGray rounded-full w-[35px] h-[35px] p-0 m-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                       stroke-width="1.5" stroke="currentColor"
                                       class="size-5 text-blue-500 m-auto">
                                      <path stroke-linecap="round" stroke-linejoin="round"
