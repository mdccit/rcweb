        ...
        <div v-for="connection in connections" class="col-span-3 p-2 ">
                ...
                <div class="bg-white p-4 border rounded-2xl w-full h-[180px]">
                    <button @click="redirect(`/app/profile/${connection.slug}`)" class=" grid grid-cols-12 gap-4">
                        ...
                        <div v-if="connection.role == 'Player'" class="col-span-3">
                            <h4 class="text-black">UTR <span  v-if="connection.other_data != null" class="text-blue-500">{{
                                                JSON.parse(connection.other_data).utr ?? '' }}</span></h4>
                        </div>
                    </button>
                    <div class="flex mt-2">
                        <div class="flex-1">
                        ...
                        <div class="flex-1 text-right">
                            ...
                            <div v-if="user_id != connection.id">
                                ...
                                <button v-if="connection.connection_status == 'pending'"
                                    class=" long-btn-card bg-blue-500 rounded-full text-white p-2 m-1 text-xs h-[35px] w-[85px]">
                                    Invite sent
                                </button>
                                <!-- <button v-if="connection.connection_status == 'pending'"
