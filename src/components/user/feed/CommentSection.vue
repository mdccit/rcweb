    ...
    <div v-for="comment in comments" :key="comment.id" class="flex space-x-3 my-5">
      ...
      <div class="flex-grow">
        ...
        <div v-if="!editingCommentId || editingCommentId !== comment.id">
          ...
          <button  :id="'post-button-' + comment.id"
                        :aria-labelledby="'post-dropdown-' + comment.id" data-dropdown-toggle="'post-dropdown-' + post.id"
           ...
           <div v-if="model_id == comment.id" id="post-dropdown"
