                ...
                <div class="flex justify-end" v-if="isAuthenticated">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <div id="dropdownUser"
                            ...
                            <div class="py-2">
                                <NuxtLink to="" class="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                    Profile</NuxtLink>
                            </div>
                            <div class="py-2">
