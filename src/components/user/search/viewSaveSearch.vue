<template>
     <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <div v-for="save in props.saveSearch"class="card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white w-full p-4 mt-3">
                <div class="flex justify-between items-center mb-4">
                    <h4 class="text-sm font-bold text-black">{{ save.name }}</h4>
                    <button @click="applySearch(save)" class="flex text-orangeRed text-sm">
                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                           <path fill-rule="evenodd"
                               d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                               clip-rule="evenodd"></path>
                ...
                <div class="flex h-8 mt-2">
                    <span v-if="save.search_data.user_role !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.user_role ==5?'Coaches':'Player' }}</span>
                    </span>
                    <span v-if="save.search_data.search_key !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.search_key }}</span>
                    </span>
                    <span   v-if="save.search_data.state !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span class="text-xs">{{ save.search_data.state }}</span>
                    </span>
                    <span v-if="save.search_data.city !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.city }}</span>
                    </span>
                    <span v-if="save.search_data.tuition_in_state_min !=null || save.search_data.tuition_in_state_max !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">In-state tuition |{{ save.search_data.tuition_in_state_min }}  {{ save.search_data.tuition_in_state_max }}</span>
                    </span>
                    <span v-if="save.search_data.tuition_out_state_min !=null || save.search_data.tuition_out_state_max !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">Out-state tuition |{{ save.search_data.tuition_out_state_min }}  {{ save.search_data.tuition_out_state_max }}</span>
                    </span>
                    
                    <span  v-if="save.search_data.gender !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.gender }}</span>
                    </span>
                    <span v-if="save.search_data.graduation_month !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.graduation_month }}</span>
                    </span>
                    <span v-if="save.search_data.graduation_year !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.graduation_year }}</span>
                    </span>
                    <span  v-if="save.search_data.country_id !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.country_id }}</span>
                    </span>
                    <span v-if="save.search_data.handedness !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">{{ save.search_data.handedness }}</span>
                    </span>
                    <span v-if="save.search_data.utr_min !=null || save.search_data.utr_max !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">UTR |{{ save.search_data.utr_min }}  {{ save.search_data.utr_max }}</span>
                    </span>
                    <span v-if="save.search_data.wtn_min !=null || save.search_data.wtn_max !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">WTN |{{ save.search_data.wtn_min }}  {{ save.search_data.wtn_max }}</span>
                    </span>
                    <span v-if="save.search_data.atp_ranking !=null"  class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span  class="text-xs">APT | {{ save.search_data.atp_ranking }}</span>
                    </span>
                    <span   v-if="save.search_data.itf_ranking !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
                        <span class="text-xs">ITF | {{ save.search_data.itf_ranking }}</span>
                    </span>
                    <span  v-if="save.search_data.national_ranking !=null" class="bg-steelBlue text-white px-2.5 py-0.5 rounded-md mr-2">
