    ...
    <div v-for="data in props.data" class="flex-1 p-2">
        <div 
            ...
            <div class="flex-1 p-1">
                <div v-if="props.userId == data.receiver_id " class="cursor-pointer grid grid-cols-12 gap-4" @click="redirect(`/app/profile/${data.sender_slug}`)">
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <div class="text-xs ml-2 text-black">{{ data.sender_city }} {{ data.sender_city !=null ?',':'' }}  {{ data.sender_country }}</div>
                        </div>
                    </div>
                ...
                <div v-if="props.userId == data.sender_id " class="cursor-pointer grid grid-cols-12 gap-4" @click="redirect(`/app/profile/${data.receiver_slug}`)">
                    <div class="col-span-3">
                        <!-- <img class=" rounded-2xl w-[85px] h-[85px]"
                            src="../../assets/user/images/Rectangle 193.png" alt="Neil image"> -->
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <div class="text-xs ml-2 text-black">{{ data.receiver_city }} {{ data.receiver_city !=null ?',':'' }}  {{ data.receiver_country }}</div>
                        </div>
                    </div>
            ...
            <div  class="flex mt-2">
                ...
                <div class="flex-1 text-right">
                    <div class="flex">
                        ...
                        <div>
                            <button  @click="chatStart(data)" class="bg-lighterGray rounded-full w-[35px] h-[35px] p-0 m-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor"
                                    class="size-5 text-blue-500 m-auto">
                                    <path stroke-linecap="round" stroke-linejoin="round"
