          ...
          <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-4">
            <div class="radio">
              <input class="radio-input absolute h-24 m-0 cursor-pointer z-2 opacity-0" id="player" type="radio"
                value="player" v-model="role" name="default-radio">
              <div
                class="radio-tile rounded-md flex flex-col items-center justify-center border border-gray-300 h-full transition-all duration-300 ease-in">
            ...
            <div class="radio">
              <input class="radio-input absolute h-24 m-0 cursor-pointer z-2 opacity-0" id="coach" type="radio"
                value="coach" v-model="role" name="default-radio">
              <div
                class="radio-tile rounded-md flex flex-col items-center justify-center border border-gray-300 h-full transition-all duration-300 ease-in">
            ...
            <div class="radio">
              <input class="radio-input absolute h-24 m-0 cursor-pointer z-2 opacity-0" id="parent" type="radio"
                value="parent" v-model="role" name="default-radio">
              <div
                class="radio-tile rounded-md flex flex-col items-center justify-center border border-gray-300 h-full transition-all duration-300 ease-in">
                <img class="mt-1" src="@/assets/images/coach_icon.png">
            ...
            <div class="radio">
              <input class="radio-input absolute h-24 m-0 cursor-pointer z-2 opacity-0" id="business" type="radio"
                value="business" v-model="role" name="default-radio">
              <div
                class="radio-tile rounded-md flex flex-col items-center justify-center border border-gray-300 h-full transition-all duration-300 ease-in">
                <img class="mt-1" src="@/assets/images/coach_icon.png">
            ...
            <div class="space-y-4">
              <div>
                <label for="nationality"
                  class="font-normal block mb-2 text-sm text-gray-900 dark:text-gray">Nationality *</label>
                <NationalityDropdown :nationalities="nationalities" v-model="nationality" id="nationality" label="Nationality *" />
              </div>
            </div>

            <div>
              <label for="mobileCode" class="block mb-2 text-sm font-normal text-gray-900 dark:text-gray">Mobile
                No</label>
