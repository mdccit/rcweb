        ...
        <div id="headlessui-dialog-panel-17" data-headlessui-state="open" unmount="true"
           ...
           <div class="sm:flex sm:items-start">
               <div class="text-center sm:mt-0 sm:text-left">
                   <h3 class="text-lg leading-6 font-medium text-gray-900">Delete Resource Category</h3>
                   <div class="mt-2">
                       <p class="text-sm text-gray-500">Are you sure you want to delete this resource category?</p>
                   </div><!----><!---->
               </div>
           </div>
...
const submit = async () => {
    ...
    try {
        ...
        const response = await $adminService.resource_category_delete(props.categoryId);
        console.log(6655)
