    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="">
        <div class="flex justify-between h-16 w-full">
          <div class="shrink-0 flex items-center"><a href="https://qa1.recruited.qualitapps.com/admin"><svg
                class="block h-9 w-auto" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="hidden space-x-6 sm:-my-px sm:ml-10 sm:flex"><a href="https://qa1.recruited.qualitapps.com/admin"
          ...
          <div class="hidden sm:flex sm:items-center sm:ml-6">
            <div class="ml-3 relative">
              <div style="position: relative;">
                <div><button type="button" aria-haspopup="true" class=""><button
                      class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition"><img
                        class="h-8 w-8 rounded-full object-cover"
                        src="https://ui-avatars.com/api/?name=A&amp;color=7F9CF5&amp;background=EBF4FF"
                        alt="Admin"></button></button></div>
                <div>
                  <div data-splade-dropdown-id="Mvda55AEv0BZ9tr1" class="absolute z-40"
                    data-popper-placement="bottom-start"
      ...
      <div class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          <div class="flex items-center px-4">
            <div class="shrink-0 mr-3"><img class="h-10 w-10 rounded-full object-cover"
                src="https://ui-avatars.com/api/?name=A&amp;color=7F9CF5&amp;background=EBF4FF" alt="Admin"></div>
            <div>
