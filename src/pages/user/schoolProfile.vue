                    ...
                    <div class="card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white w-full p-6 mt-2">
                        ...
                        <div class="grid grid-cols-2">
                            <div class=" col-span-1 text-left">
                                <h1 class="text-lg font-semibold mb-1 text-black">$38,456 <span class="text-xs">per year</span></h1>
                                <p class="text-black text-xs">Earnings 1 Year After Graduation </p>
                            </div>
                            <div class=" col-span-1 text-left">
                                <h1 class="text-lg font-semibold mb-1 text-black">$45,234<span class="text-xs">per year</span></h1>
