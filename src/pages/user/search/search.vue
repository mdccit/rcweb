<template>
            ...
            <div class="flex flex-wrap gap-2 my-4">
                <div class="flex-1">
                    <div class="flex flex-wrap">
                        <div v-for="filter in searchStore.searchFilter"
                            class="inline-flex mb-1 items-center bg-steelBlue text-white px-3 py-1 rounded-md mr-2">
                            <div>
                                <span class="text-sm">{{ filter.display_value }}</span>
                            </div>
                            <button @click="filterRemove(filter.name)"
                                class="ml-2 focus:outline-none hover:bg-brightSkyBlue" aria-label="Remove tag">
                ...
                <div class="flex-3">
                    <div
                        class="flex items-center border-lightSteelBlue bg-white rounded-full overflow-hidden px-3 py-4 divide-x h-10">
                                ...
                                <div class="col-span-8">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2 mb-2">
                                                ...
                                                <div class="text-xs ml-2 text-steelBlue">Tennis {{ user.user_role }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div v-if="user.user_role == 'Player'"
                                        ...
                                        <p v-if="user.other_data != null" class="text-xs">SAT Score : <span>{{
                                            JSON.parse(user.other_data).sat_score ?? '' }}</span></p>
                                    </div>
                                    <div class="flex items-center mt-2 text-sm text-gray-500">
                                        <p v-if="user.city != null || user.country != null" class="flex text-black">
                                            ...
                                            <span class="text-xs ml-2 text-black"> {{ user.city }}, {{ user.country
                                                }}</span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex mt-2">
                            ...
                            <div class="flex-1 text-right">
                                <div class="flex">
                                    ...
                                    <div v-if="user.connection == null">
                                        <button @click="connect(user.userId)"
    ...
    /> -->
    <SaveSearch :isOpen="showPopup" @close="showPopup = false" />
