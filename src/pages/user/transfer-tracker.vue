                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex-3">
                                        <span
                                            ...
                                            <span class="text-steelBlue ml-2">30.01</span> </span>
                                    </div>
                                </div>
                                <div class="flex mt-2">
                                    <div class="flex-1">
                                    ...
                                    <div class="flex-3">
                                        <span class="text-black text-xs p-1 text-sm text-right">L
                                            - 5</span>
                                        <span
                                            class="text-steelBlue ml-2text-xs text-sm rounded-md text-right">W-10</span>
                                    </div>
                                </div>
                                <div class="flex mt-2">
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            <div class="text-xs ml-2 text-darkSlateBlue">Whittier College</div>
                                        </div>
                                    </div>
                                    <div class="flex-3">
                                        <span class="text-darkSlateBlue text-xs p-1 text-sm text-right">(316)
                                            555-01116</span>
                                    </div>
                                </div>
                                <div class="flex mt-2">
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            <div class="text-xs ml-2 text-darkSlateBlue">Right handed</div>
                                        </div>
                                    </div>
                                    <div class="flex-3">
                                        <span
                                            class="text-darkSlateBlue text-xs p-1 text-sm text-right">ismsm12r@gmail.com</span>
                                    </div>
                                </div>
                                <div class="flex mt-2">
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            <div class="text-xs ml-2 text-darkSlateBlue">6.1 ft</div>
                                        </div>
                                    </div>
                                    <div class="flex-3">
                                        <span class="text-darkSlateBlue text-xs p-1 text-sm text-right">Male</span>
                                    </div>
                                </div>
                            </div>
                        </div>
