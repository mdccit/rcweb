                ...
                <div class="col-span-5 sm:col-span-1 md:col-span-5 lg:col-span-1 xl:col-span-1">
                    ...
                    <div>
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-center">Jane Cooper</h3>
                            <h5 class="text-normal text-md text-center">Tennis player</h5>
                        </div>
                    </div>
                    ...
                    <div class=" card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white p-3 mt-3">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4 w-48">
                                ...
                                <h1 class="text-lg font-semibold mb-4">Bio</h1>
                            </div>
                        </div>
                        <p class="text-xs text-darkSlateBlue leading-relaxed">Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit,
                    ...
                    <div class=" card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white p-3 mt-3">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4 w-48">
                                ...
                                <h1 class="text-lg font-semibold mb-4">Info</h1>
                            </div>
                        </div>
                    ...
                    <div style="height: 70px;"
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="col-span-2 ...">
                                <p class="text-xs text-darkSlateBlue leading-relaxed mx-auto">Has $5,000 - $10,000
                                </p>
                    ...
                    <div style="height: 70px;"
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="col-span-2 ...">
                                <p class="text-xs text-darkSlateBlue leading-relaxed mx-auto">Signed up 2023 May 4
                                </p>
                ...
                <div class="col-span-5 sm:col-span-3 md:col-span-5 lg:col-span-2 xl:col-span-3">
                    ...
                    <div class="card rounded-2xl overflow-hidden border border-lightSteelBlue bg-white w-full p-6 mt-3">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                    ...
                                                    <img class=""
                                                        src="@/assets/user/images/Group 89.png" alt="">
                        ...
                        <div class="mt-4 flex items-start space-x-4">
                            <img src="@/assets/user/images/Rectangle 193.png" alt="User Image"
