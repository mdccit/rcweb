    ...
    <main class="flex-1 bg-graySnowDrift overflow-y-auto mt-14">
        <div>
            <section class="grid gap-4 grid-cols-5 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5">
                                ...
                                <div class="flex mt-2">
                                    ...
                                    <div class="flex-1 text-right">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <button class="bg-blue-500 rounded-full  p-2 m-1 text-xs h-[35px] w-[85px]"> Connect +
                                                </button>
                                            </div>
                                        </div>
                ...
                <div class="col-span-5 sm:col-span-1 md:col-span-5 lg:col-span-1 xl:col-span-1">
                    <div>
                        <button type="button" class=" w-[50px] h-[50px] text-blue-500 bg-gray hover:bg-blue-100 focus:outline-none focus:ring-4 focus:ring-blue-300
