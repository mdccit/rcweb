                ...
                <form @submit.prevent="updateBusinessDetails">
                    <div class="flex flex-row gap-16">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <img v-if="profile == null" src="@assets/images/business.png" alt="SchoolAdm1"
                                ...
                                <div>
                                    <label class="block">
                                        <a
                                            ...
                                            Select A New Photo
                                            <input name="icon" @change="handleFileChange" type="file"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <img v-if="cover == null" src="@assets/images/image.svg" alt="School page background"
                                    class="rounded-full h-20 w-20 object-cover">
                                ...
                                <div>
                                    <label class="block">
                                        <a
                                            ...
                                            Select A New Photo
                                            <input name="cover" type="file" @change="handleFileCoverChange"
                                                class="invisible absolute inset-0 w-full h-full disabled:opacity-50">
                                        </a>
                                    </label>
                                </div>
                    ...
                    <div class="my-8">
                        <label class="block">
                            ...
                            <div class="flex rounded-lg border border-gray-300 shadow-sm rounded-[10px]">
                                <input v-model="name" class="lock text-black px-5 py-3 w-full border-0 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-lg border border-gray-300"
