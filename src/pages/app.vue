...
onMounted(async () => {
  ...
  userId.value = userStore?.user?.user_id || null; // Set to null if user_id is not available
  userRole.value = userStore?.user?.role || null; // Set to null if role is not available
