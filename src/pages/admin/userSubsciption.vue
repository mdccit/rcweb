<template>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex w-full justify-between gap-8 mb-3">
            <h2 class="font-bold text-lg self-center text-black">User Subscription History</h2>
                ...
                <div class="flex-1">
                    <div class="mt-2 flex flex-row">
                        <img src="https://ui-avatars.com/api/?name=e+e&amp;color=7F9CF5&amp;background=EBF4FF"
                            alt="User Photo" class="rounded-full h-20 w-20 object-cover border" />
                        <div class="mt-4 ml-3">
                            <h2 class="">User Name</h2>
                            <h4 class="text-sm">Role</h4>
                        </div>
