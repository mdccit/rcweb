    ...
    <div class="py-12 text-black">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex gap-x-4">
                <NuxtLink to="/admin/schools/9cdafef1-e0ff-4033-b402-6a36f9408551"><button
                        class="text-black px-4 py-2 rounded hover:bg-gray-200 transition duration-200 opacity-50">
                        General Details </button></NuxtLink>
                <NuxtLink to="/admin/schools/9cdafef1-e0ff-4033-b402-6a36f9408551/teams"><button
                        class="text-black px-4 py-2 rounded hover:bg-gray-200 transition duration-200 opacity-50"> Staff
                        &amp; Teams </button></NuxtLink>
                <NuxtLink to="/admin/schools/9cdafef1-e0ff-4033-b402-6a36f9408551/sync"><button
                        class="text-black px-4 py-2 rounded hover:bg-gray-200 transition duration-200 opacity-50">
                        Synchronization </button></NuxtLink>
                <NuxtLink to="/admin/schools/9cdafef1-e0ff-4033-b402-6a36f9408551/danger-zone"><button
