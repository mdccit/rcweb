        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex w-full justify-between gap-8">
                <div class="flex items-center gap-4">
                    ...
                    <h2 class="font-bold text-black text-lg self-center">Create post </h2>
                </div>
                <div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form data-splade-id="YWKGLP1SiZYWTet8" method="POST"
                    action="https://qa1.recruited.qualitapps.com/admin/resources">
                    <fieldset>
                        <div class="w-full">
                            <label class="block">
                                ...
                                <div class="flex rounded-lg border border-gray-300 shadow-sm">
                                    ...
                                    disabled:bg-gray-50 disabled:cursor-not-allowed rounded-lg" name="title"
                        ...
                        <div class="w-full">
                            <label class="block">
                                ...
                                <div class="relative">
                                    <div class="">
                                        <select name="category_id" data-validation-key="category_id"
                                            ...
                                            <option value="3"> Elegibility </option>
                                            <option value="4"> Immigration/Visas </option>
                                            <option value="5"> Life in the USA </option>
                                            <option value="6"> Transfer Information </option>
                                            <option value="7"> ACT &amp; SAT </option>
                                            <option value="8"> NIL Information </option>
                                            <option value="10"> Navigating Recruited </option>
                                            <option value="11"> College Tennis Format </option>
                                            <option value="12"> Scholarship Guide </option>
                                            <option value="13"> Test Category </option>
                                        </select>
                                    </div>
                                </div>
                            </label>
