      ...
      <div class="container max-w-7xl m-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-8">
          ...
          <!-- <div class="flex flex-col gap-4">
            ...
            <div class="flex-1 self-center"><strong>Free helpful resources for students & parents
              </strong> Everybody needs a
              Everybody needs a little help sometimes. We cover everything from how the college tennis format is to how
              to approach recruiting and life as a student-athlete. </div>
          </div>
          <div class="flex flex-col gap-4">
            <div><svg class="w-12 h-12" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
