      ...
      <div class="container">
        ...
        <div v-if="users.length > 0">
            ...
            <a class="flex flex-row gap-4 flex-1">
                <img :src="user.profile_image || `https://ui-avatars.com/api/?name=${user.display_name}&color=7F9CF5&background=EBF4FF`" 
            ...
            <div class="self-center">
                ...
                <div>
                    <button type="submit" class="border rounded-full text-black shadow-sm font-bold py-2 px-4 focus:outline-none focus:ring focus:ring-opacity-50 bg-white hover:bg-gray-100 text-gray-700 border-gray-300 focus:border-primary-300 focus:ring-primary-200">
                    Add to school
                    </button>
                </div>
                </form>
