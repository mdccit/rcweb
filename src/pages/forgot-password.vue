            ...
            <div class="w-full mt-6 mx-4 p-12 bg-white rounded-lg soverflow-hidden sm:max-w-lg ">
                ...
                <ul class="list-disc ml-8 text-gray-700">
                    ...
                    <li>Have another issue? Please send an email to us at <a href="mailto:hello@recruited.pro"
                            class="font-bold text-steelBlue">hello@recruited.pro</a> from the email you signed up with
                        and
                        we will help you.</li>
                </ul>
                <div class="m-12"></div>
                ...
                <form @submit.prevent="sendResetPasswordRequest">
                    <div class=""><label class="block"><span class="block mb-1 text-gray-700 font-sans"> Email <span
                            ...
                            <div class="flex rounded-lg border border-gray-300 shadow-sm"><input
                                    class="block px-5 py-3 w-full border-0 focus:border-lightAzure focus:ring text-black focus:ring-lightPastalBlue focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed rounded-lg"
