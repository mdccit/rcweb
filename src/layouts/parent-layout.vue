    ...
    <main class="bg-graySnowDrift">
        <div class="grid grid-cols-6 grid-rows-2 gap-0 mt-16">
            ...
            <div class="col-start-1 col-end-2 row-start-2 row-end-3">
                <ParentLeft :data="parentData" :userSlug="route.params.slug" :parentId="parentId" @updateData="fetchUserDetailsBySlug" />
            </div>
            ...
            <div class="col-start-2 col-end-6 row-start-2 row-end-3">
                <!-- <ParentFeed/> -->
                <UserFeed v-if="tab === 'feed'" :posts="posts" @profileView="redirectPage" @listpost="loadInitfintePost" :commentHidden="isHidddenComment" :tab="tab" />
                ...
                <ChilTab v-if="tab === 'child'" :getChild="child" :userSlug="route.params.slug" @updateData="fetchUserDetailsBySlug"  />
